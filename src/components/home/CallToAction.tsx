  ...
  <section className="relative py-24 md:py-32 px-6 overflow-hidden bg-slate-50">
    ...
    <div className="relative z-10 max-w-3xl mx-auto text-center space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
        <Button className="h-12 rounded-lg text-base bg-primary hover:bg-primary/90 text-white shadow-xl shadow-slate-900/20 transition-all group cursor-pointer">
          Explore Moodpin
